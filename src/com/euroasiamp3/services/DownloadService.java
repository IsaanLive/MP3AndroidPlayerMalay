...
import com.euroasia.in.DownloadingActivity;
...
public class DownloadService extends Service {
	...
	public class DownloadFilesTask  extends AsyncTask<String, Void, Void> {
		...
		protected void onCancelled() {
			...
			regularNotif("Muat turun dibatalkan","Dibatalkan: "+filename,filename); 
		...
		protected void onPostExecute(Void result) {
			...
			if(fail == 1){
				regularNotif("Muat turun gagal","Gagal: "+filename,filename); 
				http--;
				...
				regularNotif("Muat turun selesai","Selesai: "+filename,filename); 
			}
		...
		public void ongoingNotif(String contentTitle, String tickerText, String contentText ){
			...
			notification.setLatestEventInfo(context, contentTitle, "Klik disini untuk tinjauan seterusnya", contentIntent);
			notificationManager.notify(numberd+9, notification);
		}
